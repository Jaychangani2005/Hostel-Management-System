            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse" id="mobile_menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class=""><a href="Portal.php">Home</a></li>
...
"> Hostel Packages </h1>
    ...
    <div class="">
        ...
        <div class="info">
            ...
            <div class="info_para">
                <p>
                    Stay cool and relaxed in our Deluxe Room, which comes with air conditioning for a pleasant experience.                </p>
            </div>
            <table class="fees-table">
                ...
                <tbody>
                    <tr>
                        <td>Deluxe (3 Students)</td>
                        <td>68,350/-</td>
                        <td>29,000/-</td>
                        <td class="highlight">97,350/-</td>
                    </tr>
                </tbody>
            </table>
