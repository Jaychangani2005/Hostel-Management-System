...
"> Hostel Packages </h1>
    ...
    <div class="">
        ...
        <div class="info">
            ...
            <div class="info_para">
                <p>
                    Our Standard Room is a budget-friendly option with all the basics you need, but without air conditioning.                       </p>
            </div>
            <table class="fees-table">
                ...
                <tbody>
                    <tr>
                        <td>Standard (3 Students)</td>
                        <td>63,350/-</td>
                        <td>29,000/-</td>
                        <td class="highlight">92,350/-</td>
                    </tr>
                </tbody>
            </table>
